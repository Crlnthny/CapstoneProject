...
<nav class="header-nav ms-auto">
  ...
  <main id="main" class="main">
    ...
    <div class="col-lg-6">
            ...
            <a href="addproducts.php" data-bs-toggle="modal" data-bs-target="#Add" class="btn btn-primary">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                          $query = "SELECT * FROM addproducts ORDER BY id DESC";
                        ...
                        ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="assets/img/<?php echo $row['picture'];?>" width="130px" height="100px"></td>
                                    ...
                                    <td>
                                        <button type="submit" value="Update" class="action btn btn-success" data-bs-toggle="modal" data-bs-target="#Update-<?php echo $row['id'];?>"><i class="fas fa-pencil-alt"></i></button>
                                    </td>
                                    <td>
                                        <a class="action delete btn btn-danger" href="admindelete.php?id=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                                    ...
                                                    <form action="adminprocess.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <label>Product Name: </label>
                                                                <div class="input-group">
                                                                    <input type="text" name="itemName" id="itemName" value="<?php echo $row['itemName']; ?>" style="border: 1px solid" class="form-control" required>
                                                                </div>
                                                                </p>
                                                                <label>Availability: </label>
                                                                <div class="input-group">
                                                            ...
                                                            <div class="col">
                                                                <label>Description: </label>
                                                                <div class="input-group">
                                                                    <input type="text" name="description" id="description" value="<?php echo $row['description']; ?>" style="border: 1px solid" class="form-control" required>
                                                                </div>
                                                                </p>
                                                                <label>Sizes: </label>
                                                                <div class="input-group">
