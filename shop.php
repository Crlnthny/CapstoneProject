  ...
  <head>
	...
	<style>
		.hero-wrap.hero-bread {
			position: relative;
			background-image: url('images/bg4.jpg'); /* Add your image path */
			...
			bottom: 0;
			left: 0;
			background-color: rgba(255, 255, 255, 0.3); /* Adjust the alpha value for the overlay transparency */
			}

			/* Media query for smaller screens */
			@media (max-width: 767px) {
			.hero-wrap.hero-bread::before {
				background-color: rgba(255, 255, 255, 0.6); /* Adjust the alpha value for the overlay transparency on smaller screens */
			}
		}
        ...
        .add-to-cart-btn,
        .btn.btn-primary {
            padding: 10px 50px; /* Adjust padding as needed for smaller screens */
            font-size: 18px; /* Adjust font size as needed for smaller screens */
        }
    }
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/bg4.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center fw-bold">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
                        <form action="process.php" method="POST" class="product-form" enctype="multipart/form-data">
                            <div class="product">
                                <img src="admin/assets/img/<?php echo $row['picture'];?>" class="img-fluid" alt="Product Image">
                                <div class="overlay"></div>
                                <input type="hidden" name="pic" value="<?php echo $row['picture'];?>" >
                                <div class="text py-3 px-3">
                                    <h3 class="h5" name="itemName"><?php echo $row['itemName']; ?></h3>
                                    <input type="hidden" name="itemName" value="<?php echo $row['itemName'];?>">
                                    <div class="d-flex justify-content-between">
                                        <p class="price" name="price"><span>₱<?php echo $row['price']; ?></span></p>
