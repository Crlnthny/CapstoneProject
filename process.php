<?php
    ...
    // Check if the form for adding to cart has been submitted
if(isset($_POST['add_to_cart'])) {
    // Retrieve the logged-in user's email from the session
    $email = $_SESSION['email'];

    // Retrieve the other form data from the POST request
    $picname = $_POST['pic'];
    ...
    $insert = mysqli_query($conn, "INSERT INTO cart 
        VALUES ('0','$picname','$itemname','$sizes','$quantity','$price','$email')");
