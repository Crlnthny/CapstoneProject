<?php
    ...
    while($row = mysqli_fetch_object($get_name)){
		...
		$add_cart = mysqli_query($conn, "SELECT * FROM cart");
        ...
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
                ...
                <div class="w-100"></div>
					...
					<div class="col-md-6">
		            	<div class="form-group">
	                	<label for="streetaddress">Date of Birth</label>
	          	...
	          	<div class="col-md-6">
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<p><a href="#"class="btn btn-primary py-3 px-4" id="openConfirmationModalBtn">Place an order</a></p>
								</div>
	          	</div>
	          </div>
          </div> <!-- .col-md-8 -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to proceed and place this order?</p>
            </div>

            <!-- Modal Footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <a href="#" class="btn btn-primary" id="finalPlaceOrderBtn">Place Order</a>
            </div>
